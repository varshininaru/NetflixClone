...
const WatchPage = () => {
  ...
  const { contentType: storeContentType } = useContentStore();

  const sliderref = useRef(null);

  const contentType = typeParam || storeContentType || 'movie';
    ...
    <div className='bg-black min-h-screen text-white'>
      <div className='mx-auto container px-4 py-8 h-full'>
        ...
        <div className='flex flex-col md:flex-row items-center justify-between gap-20 max-w-6xl mx-auto'>
          ...
          <img src={ORIGINAL_IMG_BASE_URL + content?.poster_path} alt={content?.title || content?.name} className='rounded-lg shadow-lg max-h-[550px] object-cover' />
        </div>
